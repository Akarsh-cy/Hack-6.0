      ...
      <div className="container mx-auto px-4 sm:px-6 pt-32 pb-24 max-w-7xl">
        ...
        <div className="mb-14">
          <div className="mx-auto max-w-4xl border-2 border-[#292929] bg-[#eeeeee] p-4 sm:p-5 shadow-[5px_5px_0_#8a2be2]">
            ...
            {/* Status Footer on Filter Bar */}
            <div className="mt-3 pt-2.5 border-t border-[#ccc] flex items-center justify-between font-mono text-[9px] uppercase tracking-wider text-[#555]">
              <span>SHOWING: {filteredMembers.length} ACTIVE PROFILES</span>
              <span className="font-bold text-[#8a2be2]">DIRECTORY_LOADED</span>
            </div>
          </div>
        </div>
